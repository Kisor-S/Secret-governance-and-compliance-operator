...
type SecretPolicyStatus struct {
	...
	// conditions represent the current state of the SecretPolicy resource.
...
type SecretPolicy struct {
	...
	// spec defines the desired state of SecretPolicy
	// +required
	Spec SecretPolicySpec `json:"spec"`

	// status defines the observed state of SecretPolicy
	// +optional
	Status SecretPolicyStatus `json:"status,omitzero"`
}
